...
/**
 * FooterSocial Control. Handles data passing from args to JS.
 *
 ...
 * @package Solace\Customizer\Controls\React
 */
class FooterSocial extends \WP_Customize_Control
{
    /**
     * Control type.
     *
     * @var string
     */
    public $type = 'solace_footer_social_control';
    ...
    {
?>
        <div class="footer_social_sortable_control">
            ...
            <div class="sortable_repeater_footer_social sortable">
                <?php
            ...
            <button style="display:none;" class="button control-sortable-repeater-footer-social-add" type="button"><?php echo $this->button_labels['add']; ?></button>
